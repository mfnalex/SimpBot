...
public class SpigotMessageListener implements Listener {
    ...
    public void onChat(AsyncPlayerChatEvent e) {
        ...
        Main.getPlugin().getBot().getJDA().getGuildById(ConfigUtil.getMainGuildID()).getTextChannelById(ConfigUtil.getChatChannelID()).sendMessage("**" + e.getPlayer().getName() + "**: " + e.getMessage()).queue();
    }
}
